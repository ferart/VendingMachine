 ...
 * modified by Arthur Rocha on 02/10/2015.
 */
...
public class GifMovieView extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mMovie != null) {
			...
			*/
            ...
            mScaleH=(float)screenH/movieHeight;
            mScaleW=(float)screenW/movieWidth;

            setMeasuredDimension(widthMeasureSpec, heightMeasureSpec);//mMeasuredMovieWidth, mMeasuredMovieHeight);
    ...
    private void drawMovieFrame(Canvas canvas) {
        ...
        canvas.scale(mScaleW,mScaleH);//mScale, mScale);
        mLeft = (getWidth() - mMeasuredMovieWidth) / 2f;
        mTop = (getHeight() - mMeasuredMovieHeight) / 2f;
        mMovie.draw(canvas, 0,0);//mScaleW,mScaleH);// mLeft / mScale, mTop / mScale);
        canvas.restore();
